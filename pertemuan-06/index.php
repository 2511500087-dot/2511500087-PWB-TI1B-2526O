...
<body>
  ...
  <main>
    ...
    <?php
        $nim                = "2511500087";
        $nama               = "M. Adiib Al-Faathir";
        $tanggal_lahir      = "23 Oktober 2006";
        $status             = "Mahasiswa Baru";
        $hobi               = "Memancing";
        $ayah               =  "Dedy Heryadi";
        $ibu                = "Ica Yolanda";
        $nama_kakak         = "M.Arya Al-Faaiz,M.Bintang";
        $motto_hidup        = "Pelan Tapi Pasti";
        $pasangan           = "Dakde, Sibuk Menyendiri";
    ?>
...
?>
    ...
    <section id="about">
      ...
      <div class="about-container">
        ...
        <p><strong>Motto Hidup:</strong> <?php echo $motto_hidup; ?><</p>
